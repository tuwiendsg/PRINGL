...
namespace at.ac.tuwien.dsg.PRINGL
{
	...
	/// </remarks>
	public partial class PRINGLHelpKeywordHelper : PRINGLHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new PRINGLHelpKeywordHelper.
		/// </summary>
		protected PRINGLHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the PRINGLHelpKeywordHelper.
		/// </summary>
		public static PRINGLHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class PRINGLHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new PRINGLHelpKeywordHelperBase.
		/// </summary>
		protected PRINGLHelpKeywordHelperBase()
			: base() { }
