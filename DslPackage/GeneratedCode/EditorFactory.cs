...
namespace at.ac.tuwien.dsg.PRINGL
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.PRINGLEditorFactoryId)]
	internal partial class PRINGLEditorFactory : PRINGLEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new PRINGLEditorFactory.
		/// </summary>
		public PRINGLEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class PRINGLEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected PRINGLEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new PRINGLDocData(this.ServiceProvider, typeof(PRINGLEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new PRINGLDocView(docData, this.ServiceProvider);
		}
	}
}
