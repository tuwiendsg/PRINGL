...
namespace at.ac.tuwien.dsg.PRINGL
{
	...
	/// </summary>
	internal partial class PRINGLCommandSet : PRINGLCommandSetBase
	{
		/// <summary>
		/// Constructs a new PRINGLCommandSet.
		/// </summary>
		public PRINGLCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class PRINGLCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new PRINGLCommandSetBase.
		/// </summary>
		protected PRINGLCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewPRINGLExplorerCommand,
				typeof(PRINGLEditorFactory).GUID);
		...
		{
			PRINGLExplorerToolWindow explorer = this.PRINGLExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected PRINGLDocData CurrentPRINGLDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as PRINGLDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected PRINGLDocView CurrentPRINGLDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as PRINGLDocView;
			}
		}
		...
		/// </summary>
		protected PRINGLExplorerToolWindow PRINGLExplorerToolWindow
		{
			get
			{
				PRINGLExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(PRINGLExplorerToolWindow), true) as PRINGLExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				PRINGLExplorerToolWindow explorerWindow = this.PRINGLExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class PRINGLClipboardCommandSet : PRINGLClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new PRINGLClipboardCommandSet.
		/// </summary>
		public PRINGLClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class PRINGLClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new PRINGLClipboardCommandSetBase.
		/// </summary>
		protected PRINGLClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
