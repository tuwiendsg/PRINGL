...
namespace at.ac.tuwien.dsg.PRINGL
{
	...
	/// </summary>
	internal partial class PRINGLExplorer : PRINGLExplorerBase
	{
		/// <summary>
		/// Constructs a new PRINGLExplorer.
		/// </summary>
		public PRINGLExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the PRINGLExplorerToolWindow.
	/// </summary>
	internal abstract class PRINGLExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new PRINGLExplorerBase.
		/// </summary>
		protected PRINGLExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.PRINGLExplorerMenu;
			}
		}
		...
		{
			get { return global::at.ac.tuwien.dsg.PRINGL.IncentiveStrategy.DomainClassId; }
		}
