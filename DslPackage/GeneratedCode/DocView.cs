...
namespace at.ac.tuwien.dsg.PRINGL
{
	...
	/// </summary>
	internal partial class PRINGLDocView : PRINGLDocViewBase
	{
		/// <summary>
		/// Constructs a new PRINGLDocView.
		/// </summary>
		public PRINGLDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class PRINGLDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new PRINGLDocView.
		/// </summary>
		protected PRINGLDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			PRINGLDocDataBase docData = this.DocData as PRINGLDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for PRINGLDocViewBase should be an PRINGLDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::at.ac.tuwien.dsg.PRINGL.PRINGLDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::at.ac.tuwien.dsg.PRINGL.PRINGLDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::at.ac.tuwien.dsg.PRINGL.PRINGLToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::at.ac.tuwien.dsg.PRINGL.PRINGLToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.PRINGLDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::at.ac.tuwien.dsg.PRINGL.PRINGLHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::at.ac.tuwien.dsg.PRINGL.PRINGLHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::at.ac.tuwien.dsg.PRINGL.PRINGLHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
